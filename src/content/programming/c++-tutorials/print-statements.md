...
If you are new to where code runs in a PROS project, review [Basic C++ Syntax](basic-c++-syntax.md). Your print statements will usually live inside functions like `initialize()`, `autonomous()`, or `opcontrol()`.
...
{% code title="src/main.cpp" lineNumbers="true" %}
```cpp
#include "main.h"
#include <iostream>
...
{% code title="example.cpp" lineNumbers="true" %}
```cpp
#include <print>
