...
&#x20;Very frequently when programming, you need the ability to explain what the code is doing without affecting the functionality of the code. Therefore... **COMMENTS!** Comments are a very useful tool that can be used to explain what code is doing.&#x20;
