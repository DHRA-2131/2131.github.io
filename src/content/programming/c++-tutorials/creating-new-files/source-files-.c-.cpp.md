...
A source file contains the actual code that runs. This is where functions, class methods, and variables are **defined**. If a header file says _"this thing exists,"_ a source file says _"this is how it works."_
...
{% code title="Example project structure" %}
```
include/
  2131H/
    Drive.hpp
...
{% code title="include/2131H/Drive.hpp" %}
```cpp
#pragma once
...
{% code title="src/2131H/Drive.cpp" %}
```cpp
