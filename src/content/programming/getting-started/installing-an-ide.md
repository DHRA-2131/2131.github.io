...
<figure><img src={`${base}images/assets/image/vscode-welcome.png`} alt=""><figcaption></figcaption></figure>

Head to the settings (Gear symbol in the bottom left corner) and hover over the profiles option to select profile.&#x20;

<figure><img src={`${base}images/assets/image/vscode-select-profile.png`} alt=""><figcaption></figcaption></figure>
...
<figure><img src={`${base}images/assets/image/2131H-extension-pack.png`} alt=""><figcaption></figcaption></figure>
...
<figure><img src={`${base}images/assets/image/2131H-extension-pack-clang.png`} alt=""><figcaption></figcaption></figure>
