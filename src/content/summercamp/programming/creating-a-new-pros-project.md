...
<figure><img src="/website/images/assets/layout-example-new-folder.png" alt=""><figcaption></figcaption></figure>
...
* `compile_command.json` - This is needed for clangd to work. If it is not present, please follow the instructions here: [How to Fix Clang](../../../programming/getting-started/how-fix-clang/ "mention").
